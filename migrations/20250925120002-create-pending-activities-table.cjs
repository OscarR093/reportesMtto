...
module.exports = {
  async up (queryInterface, Sequelize) {
    await queryInterface.createTable('pending_activities', {
      ...
      status: {
        type: Sequelize.ENUM('pendiente', 'asignado', 'realizado'),
        allowNull: false,
